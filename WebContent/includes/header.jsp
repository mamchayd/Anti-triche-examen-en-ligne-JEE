...
.w3-navbar li{float:left}.w3-navbar li p,.w3-navitem,.w3-navbar li .w3-btn,.w3-navbar li .w3-input{display:block;padding:10px 10px 4px 10px}.w3-navbar li .w3-btn,.w3-navbar li .w3-input{border:none;outline:none;width:100%}
...
.w3-pagination li a{text-decoration:none;color:#000;float:left;padding:8px 10px}
...
.w3-margin-left{margin-left:16px!important; padding: 10px}.w3-margin-right{margin-right:16px!important}
.w3-section{margin-button:0px!important;margin-bottom:16px!important}
.w3-padding-tiny{padding:2px 4px!important}.w3-padding-small{padding:4px 8px!important}
.w3-padding-medium,.w3-padding,.w3-form{padding:8px 16px!important}
.w3-padding-large{padding:12px 24px!important}.w3-padding-xlarge{padding:16px 32px!important}
.w3-padding-xxlarge{padding:24px 48px!important}.w3-padding-jumbo{padding:32px 64px!important}
.w3-padding-4{padding-top:4px!important;padding-bottom:4px!important}
.w3-padding-8{padding-top:0px!important;padding-bottom:1px!important}
			...
			<div class="w3-top">
			  <ul class="w3-navbar w3-white w3-wide w3-padding-8 w3-card-2">
			    <li class=" w3-hide-small ">
			      <p class="w3-margin-left" ><b>EX</b> ONLINE<p>
			    </li>
			    <li class="w3-right w3-hide-small ">
							<form method="post" action="Deconnection">
			       			<div class="main">
							    <div class="sub-main">
							      <button class="button-one">Déconnexion</button>
							    </div>
						    </div>
						    </form>    
				</li>
			    ...
			    <li class="w3-right w3-hide-small">
			       		<p class="w3-left w3-margin-right ">${sessionScope.sessionUtilisateur.nom} ${sessionScope.sessionUtilisateur.prenom }</p>
			    </li>
			    </li>
			    <!-- Float links to the right. Hide them on small screens -->
